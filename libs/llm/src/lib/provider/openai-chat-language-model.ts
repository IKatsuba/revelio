...
export class OpenAIChatLanguageModel implements LanguageModelV1 {
  ...
  private getArgs({
    ...
    const baseArgs = {
      ...
      max_completion_tokens: providerMetadata?.openai?.maxCompletionTokens ?? undefined,
                ...
                tools: [
                  {
                    ...
                    function: {
                      ...
                      description: mode.tool.description,
                      parameters: mode.tool.parameters,
                      strict: this.settings.structuredOutputs === true ? true : undefined,
                    },
                  },
                ],
              },
  ...
  async doGenerate(
    ...
    await openai.beta.assistants.update('sxasx', {
      tools: 'tools' in body ? (body.tools as any) : [],
    });

    await openai.beta.threads.runs.createAndPoll('sxasx', {
      messages: 'messages' in body ? (body.messages as any) : [],
    });
            ...
            if (value.usage != null) {
              ...
              if (
                ...
                if (promptTokenDetails?.cached_tokens != null) {
                  providerMetadata.openai.cachedPromptTokens = promptTokenDetails?.cached_tokens;
                }
              }
            }
