...
-- AlterTable
ALTER TABLE "GroupMember" ALTER COLUMN "groupId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Subscription" ALTER COLUMN "groupId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "UsageLog" ALTER COLUMN "groupId" SET DATA TYPE BIGINT;
