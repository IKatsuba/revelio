...
ALTER COLUMN "id" SET DATA TYPE DECIMAL(65,30),
...
-- AlterTable
ALTER TABLE "GroupMember" ALTER COLUMN "groupId" SET DATA TYPE DECIMAL(65,30);

-- AlterTable
ALTER TABLE "Subscription" ALTER COLUMN "groupId" SET DATA TYPE DECIMAL(65,30);

-- AlterTable
ALTER TABLE "UsageLog" ALTER COLUMN "groupId" SET DATA TYPE DECIMAL(65,30);
